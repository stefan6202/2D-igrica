...
//					gp.playMusic(0);					
				...
				if(gp.ui.commandNum==1) {
					...
					else if(gp.currentArea==gp.dungeon && gp.bossBattleOn==true) {
						gp.playMusic(22);
					}
				}
				if(gp.ui.commandNum==2) {
			...
			if(code==KeyEvent.VK_ENTER) {
				if(gp.ui.commandNum==0) {
					gp.player.boja=gp.player.plavi;
					gp.player.getImage();
				...
				if(gp.ui.commandNum==1) {
					gp.player.boja=gp.player.zeleni;
					gp.player.getImage();
					gp.player.getAttackImage();
					gp.player.getGuardImage();
					gp.resetGame(true);
				...
				if(gp.ui.commandNum==2) {
					gp.player.boja=gp.player.crveni;
					gp.player.getImage();
					gp.player.getAttackImage();
					gp.player.getGuardImage();
					gp.resetGame(true);
