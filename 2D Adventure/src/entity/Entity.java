...
public class Entity {
	...
	GamePanel gp;
	public BufferedImage up1,up2,down1,down2,left1,left2,right1,right2,bdown1,gdown1,rdown1,ydown1,wdown1;
	...
	public void dropItem(Entity droppedItem) {	
		for(int i=0;i<gp.obj[1].length;i++) {
			if(gp.obj[gp.currentMap][i]==null) {
				...
				gp.obj[gp.currentMap][i].worldX=worldX;	//the dead monsters worldY and worldY
	...
	public void attacking() {
		...
		if(spriteCounter>=motion1_duration && spriteCounter<motion2_duration) {
			...
			//Adjust players worldx,worldy for the attackArea
			switch(direction) {
			case "up":
			...
			//after checking collisionrestore the original data
...
//			//If reaches the goal, stop the search 
			//disable this when npc follows player
